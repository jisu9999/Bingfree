    ...
    <div class="notailwind">
      ...
      <ul class="sidesection" v-show="scrollOk">
        ...
        <li
          ...
          :style="{
            color: currentSection === 'review' ? '#1456fd' : '#9E9E9E',
          }"
        >
        ...
        <li
          ...
          :style="{
            color: currentSection === 'reserv' ? '#1456fd' : '#9E9E9E',
          }"
        >
      ...
      <section class="introBing" id="intro">
        <div class="inner">
          <div class="main-introBing-txt">
            <h1 class="main-h1">
              <span style="color: #1456fd; font-weight: bold">제빙기 청소</span
              >, 왜 전문가가 필요할까요?
            </h1>
            ...
            <div class="receipt_section">
              ...
              <div class="receipt_content receipt_content card1">
                <div
                  class="front"
                  style="
                    background: url(/check/ordinary.png) no-repeat
                      center/contain;
                  "
                ></div>
                <div
              ...
              <div class="icon_content">
                <span class="icon1"
                  ><img src="/public/check/goodemoji.png" alt="아이콘"
                /></span>
                <span class="icon2"
                  ><img src="/public/check/mirror.png" alt="아이콘"
                /></span>
                <span class="icon3"
                  ><img src="/public/check/moneyemoji.png" alt="아이콘"
                /></span>
                <span class="icon4"
                  ><img src="/public/check/presentemoji.png" alt="아이콘"
                /></span>
                <span class="icon5"
                  ><img src="/public/check/dartemoji.png" alt="아이콘"
                /></span>
                <span class="icon6"
                  ><img src="/public/check/arrow_left.png" alt="아이콘"
                /></span>
                <span class="icon7"
                  ><img src="/public/check/arrow_right.png" alt="아이콘"
                /></span>
                <span class="icon8"
                  ><img src="/public/check/pointcircle.png" alt="아이콘"
                /></span>
                <span class="icon9"
                  ><img src="/public/check/pointcircle.png" alt="아이콘"
                /></span>
          ...
          <div class="review-box-total">
            <div class="review-box">
              <p class="review-box-txt">
                “바쁜 일정으로 직접 청소할 시간이 부족했는데 청소 후 리포트
                서비스로 청결도 신뢰가 가네요. 정기 관리까지 해주셔서 정말
                편하고 만족스럽습니다!”
              </p>
            ...
            <div class="review-box">
              <p class="review-box-txt">
                ...
                느꼈습니다. 빙프라임 구독 서비스로 비용도 절감하고 친환경
                세제까지 증정 받아 좋았습니다.”
              </p>
              <div class="review-customer">
            ...
            <div class="review-box">
              <p class="review-box-txt">
                ...
                확연히 개선되어 다시 깨끗하고 신선한 얼음을 사용할 수 있게
                됐어요. 정기구독 서비스 가입했답니다."
              </p>
              <div class="review-customer">
                <img
                  src="/public/review/megabox_icon.png"
                  alt="메가박스 아이콘"
                />
                <p style="font-size: 16px; font-weight: 600; color: #424242">
                  메가박스 대구점
            ...
            <div class="review-box">
              <p class="review-box-txt">
                ...
                구애 받지 않고 원하는 시간에 방문 해주셔서 자주 이용할 것
                같아요. 주변에도 추천해야겠어요 :)”
              </p>
              <div class="review-customer">
                <img src="/public/review/customer_icon.png" alt="고객 아이콘" />

  ...
  <div class="agree_box max-w-[860px] mx-auto py-20 px-6 bg-white">
    ...
    <div class="flex justify-center mb-12">
      <div class="w-[695px] h-24 relative rounded-[100px]">
        ...
        <div
          class="w-16 h-16 left-[420px] top-0 absolute bg-blue-700 rounded-[100px]"
        ></div>
        <div
    ...
    <div class="flex justify-center">
      <div
        class="w-96 h-[700px] flex flex-col items-center p-6 rounded-lg bg-white"
      >
        <img
          class="w-16 h-16 mb-4"
          src="/public/prime/SubSelct_check.png"
          alt="단계 아이콘"
        />
        <div
          class="text-center text-black text-sm font-medium font-['Pretendard'] mb-8"
        >
          1/3단계
        </div>
        <div
          class="text-center text-black text-3xl font-bold font-['Pretendard'] mb-12"
        >
          <span class="whitespace-nowrap">지금, 나에게 딱 맞는 빙프라임</span
          ><br />
          요금제를 선택하세요.
        </div>
        ...
        <div class="flex items-start mb-6 w-full">
          <img
            ...
            src="/public/prime/SubSelct_check_bluse.png"
            alt="아이콘1"
          />
          <p class="text-black text-lg font-semibold font-['Pretendard']">
            <span class="whitespace-nowrap"
              >숨겨진 비용 없이, 청소 요금은 언제나 정찰제!</span
            >
            추가 요금 걱정 없이, 필요한 만큼만 예약하세요.
          </p>
        </div>
